# copyright: https://github.com/bionet/ted.python/blob/master/bionet/utils/signal_extras.py

from numpy import abs, arange, argmin, ceil, floor, int, log2,  min, zeros
...
def fftfilt(b, x, *n):
    ...
    are selected to minimize the computational cost of
