...
\symbl{$x \lbrack n \rbrack$}{sinal de valores reais, no domínio do tempo discreto}
\symbl{$x_k \lbrack n \rbrack$}{k-ésima sub-banda do sinal, no domínio do tempo discreto}
...
\symbl{$m_k \lbrack n \rbrack$}{moduladora da k-ésima sub-banda, no domínio do tempo discreto}
\symbl{$c_k \lbrack n \rbrack$}{portadora da k-ésima sub-banda, no domínio do tempo discreto}
\begin{equation}
    x_k[n] = h_k[n] \ast x[n]
\end{equation}
\begin{equation}
