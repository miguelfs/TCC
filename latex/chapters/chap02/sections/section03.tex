...
representações que evidenciam frequências associadas a modulações presentes no
...
O chamado espectrograma de \todo{modulo?} magnitude é a representação do módulo desse domínio:
\begin{equation}
