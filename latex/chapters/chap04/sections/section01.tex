...
\textbf{Modelos baseados em redes neurais}: Inclui os modelos GRU4Rec, NARM, NextItNet, STAMP, GNN e CSRM. Os modelos GNN e
...
\begin{table}
  ...
  \label{tab:windowed_time}
  \caption{Duração média do treinamento de cada modelo da TABELA
  \ref{tab:windowed_time}.}
