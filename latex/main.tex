...
\begin{document}
  ...
  Tito Lívio, trecho de \emph{Ab Urbe Condita} (História de Roma), por volta de 27 a.C.}
  \hbadness=226
 ...
 participação de usuários do aplicativo Indaband, com as sessões de gravação como objeto de
